  ...
  messages = [
      SystemMessage(
          content="""Ты валидатор данных. Твоя задача — принимать входную информацию, валидировать её и возвращать JSON-объект с преобразованными данными. Требования:
                     ...
                     Поле "Дата":
                     Преобразуй любую входную дату в формат dd/mm/yyyy. Если формат даты некорректен или отсутствует, верни ошибку валидации.

                     Поле "Итоговая сумма":
                     Извлеки только числовую часть суммы и преобразуй её в float. Если данные некорректны (не число), верни ошибку валидации.

                     Поле "ФИО плательщика":
                     Должно быть строкой. Если данные отсутствуют или некорректны, верни ошибку валидации.
